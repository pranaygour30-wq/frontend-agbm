  ...
  const contactInfo = [
    {
      icon: MapPin,
      title: 'Visit Us',
      details: ['Adi Goud Brahmin Mahasabha', '123 Community Hall Road', 'Hyderabad, Telangana 500001']
    },
    {
      icon: Phone,
      title: 'Call Us',
      details: ['+91 9876543210', '+91 9876543211', 'Mon-Sat: 9:00 AM - 6:00 PM']
    },
    {
      icon: Mail,
      title: 'Email Us',
      details: ['contact@agbmahasabha.org', 'support@agbmahasabha.org', 'We reply within 24 hours']
    }
  ];
                ...
                <CardContent className="pt-6">
                  <div className="flex items-start gap-4">
                    ...
                    <div className="flex-1">
                      <h4 className="text-foreground mb-2">{info.title}</h4>
